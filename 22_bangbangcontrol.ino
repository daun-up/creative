...
// Servo adjustment
#define _DUTY_MAX 2482  // Servo angle: D degree
#define _DUTY_NEU 1472  // Servo angle: 0 degree
#define _DUTY_MIN 509   // Servo angle: E degree
#define _SERVO_ANGLE_DIFF 169 // Replace with |D - E| degree
...
// Replace the below line with the equation obtained from nonlinear regression analysis
  return 595 +- 1.96*a_value + 1.7E-03 * a_value * a_value;
}
